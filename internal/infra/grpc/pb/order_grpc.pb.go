...
type OrderServiceClient interface {
	...
	FindAllOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderList, error)
}
...
func (c *orderServiceClient) FindAllOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderList, error) {
	out := new(OrderList)
...
type OrderServiceServer interface {
	...
	FindAllOrder(context.Context, *Blank) (*OrderList, error)
...
func (UnimplementedOrderServiceServer) FindAllOrder(context.Context, *Blank) (*OrderList, error) {
...
func _OrderService_FindAllOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).FindAllOrder(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
